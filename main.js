...
function start() {
  document.getElementById("status").innerHTML = "o sistema ta ouvindo,podemos falar"
  recognition.start()
}
...
function draw() {
  if(drawCircle == "set") {
    ...
    circle(x,y,radius)
    document.getElementById("status").innerHTML = "um circulo desenhando"
    drawCircle = ""
  }
  if(drawRect == "set") {
    
    rect(x,y,70,50)
    document.getElementById("status").innerHTML = "um retangulo desenhado"
    drawRect = ""
  }
